...
// CopySecretToRemoteCluster will get the Secret from src
// and create it on the remote cluster, copying Data and StringData to dst Secret.
func CopySecretToRemoteCluster(
	ctx context.Context,
	cl ctrlclient.Client,
	src *corev1.LocalObjectReference,
	dst ctrlclient.ObjectKey,
	...
	err = EnsureNamespace(ctx, remoteClient, dst.Namespace)
	if err != nil {
